...
An autonomous chess-playing robotic arm built with **Python**, powered by **Stockfish** for chess intelligence, and driven by a **Ramps 1.4** controller for precise stepper motor control. Developed using **Thonny IDE** for rapid testing and deployment. Built in **2023** by **Gunapu Bhargava**.
...
<div align="center">
  <img src="images/arm_front.jpg" alt="Front view of robotic arm" width="30%" />
